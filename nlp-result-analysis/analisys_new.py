...
def Aalysis(file_path, color, subplot_arg):
    ...
    languages = {
      'EN':   {'lan': 0, 'di': 0, 'sub-fa': 'Ge', 'fa': 0},
      'DE':    {'lan': 1, 'di': 0, 'sub-fa': 'Ge', 'fa': 0},
      'NL':     {'lan': 2, 'di': 0, 'sub-fa': 'Ge', 'fa': 0},
      'ES':   {'lan': 3, 'di': 0, 'sub-fa': 'Ro', 'fa': 0},
      'PT': {'lan': 3, 'di': 1, 'sub-fa': 'Ro', 'fa': 0},
      'FR':    {'lan': 4, 'di': 0, 'sub-fa': 'Ro', 'fa': 0},
      'PL':    {'lan': 5, 'di': 0, 'sub-fa': 'Sl', 'fa': 0},
      'HU': {'lan': 6, 'di': 0, 'sub-fa': 'Ug', 'fa': 1},
      'FI':   {'lan': 7, 'di': 0, 'sub-fa': 'Ba', 'fa': 1}
    }
...
Aalysis("./print_pre_results/result_prerun.txt", 'blue', ax1)
